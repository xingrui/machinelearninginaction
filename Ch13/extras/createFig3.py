...
ax.scatter(label0Mat.A[:,0],zeros(shape(label0Mat)[0]), marker='^', s=90)
ax.scatter(label1Mat.A[:,0],zeros(shape(label1Mat)[0]), marker='o', s=50,  c='red')
ax.scatter(label2Mat.A[:,0],zeros(shape(label2Mat)[0]), marker='v', s=50,  c='yellow')
plt.show()
